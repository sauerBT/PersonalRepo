function [tout, yout] = rtk4_interchange(FunFcn, tspan, y0, ssize, M0, Xa10, Xb10, timeC1, timeC2, ssM, alpha, beta)
...
while (k < N)
  ...
  % Compute the slopes
  s1 = feval(FunFcn, t, y, M0, Xa10, Xb10, timeC1, timeC2, ssM, alpha, beta); s1 = s1(:);
  s2 = feval(FunFcn, t + h/2, y + h*s1/2, M0, Xa10, Xb10, timeC1, timeC2, ssM, alpha, beta); s2=s2(:);
  s3 = feval(FunFcn, t + h/2, y + h*s2/2, M0, Xa10, Xb10, timeC1, timeC2, ssM, alpha, beta); s3=s3(:);
  s4 = feval(FunFcn, t + h, y + h*s3, M0, Xa10, Xb10, timeC1, timeC2, ssM, alpha, beta); s4=s4(:);
