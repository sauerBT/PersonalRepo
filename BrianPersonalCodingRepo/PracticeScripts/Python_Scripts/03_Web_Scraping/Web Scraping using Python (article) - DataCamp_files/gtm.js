...
"resource": {
  ...
  "rules":[
    [["if",0],["add",0,4,6,7,8,14,29,30,17,18,19,20,23,26]],
    [["if",1],["add",1]],
    [["if",2],["add",2,6,7,9,25]],
    [["if",3],["add",3,7,21,31]],
    [["if",4,5],["add",3,7,31]],
    [["if",6,8],["add",4,6,7,8,29]],
    [["if",9,10,11,12],["add",5]],
    [["if",4,13],["add",6,7,9]],
    [["if",14],["add",10,28]],
    [["if",4,15],["add",10]],
    ...
    [["if",18],["add",15,16,33]],
    [["if",8],["add",22,24,27]],
    [["if",7],["unless",6],["block",3,4,5,6,8,9,10,12,13,14,29,31,32]]]
},
"runtime":[
[],[]
]
...
function mc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.h[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var oc={},pc=null,qc=Math.random();oc.m="GTM-TGGWB2P";oc.zb="9p0";var rc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0},sc="www.googletagmanager.com/gtm.js";var tc=sc,uc=null,vc=null,wc=null,xc="//www.googletagmanager.com/a?id="+oc.m+"&cv=37",yc={},zc={},Ac=function(){var a=pc.sequence||0;pc.sequence=a+1;return a};var Bc={},Dc=function(a,b){Bc[a]=Bc[a]||[];Bc[a][b]=!0},Ec=function(a){for(var b=[],c=Bc[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
