...
"""
data_mine["Weight"] = pd.to_numeric(data_mine["Weight"])
data_mine["ACTUAL SCREW SPEED"] = pd.to_numeric(data_mine["ACTUAL SCREW SPEED"])
data_mine["SERVO CURRENT"] = pd.to_numeric(data_mine["SERVO CURRENT"])
data_mine["SCREW SPEED SP"] = pd.to_numeric(data_mine["SCREW SPEED SP"])
data_mine["FEEDRATE SP"] = pd.to_numeric(data_mine["FEEDRATE SP"])
data_mine["REGRESSED FEEDRATE"] = pd.to_numeric(data_mine["REGRESSED FEEDRATE"])
data_mine["FEEDFACTOR"] = pd.to_numeric(data_mine["FEEDFACTOR"])
"""
Define Data Arrays
"""
